...
JNIEXPORT void JNICALL
Java_MediaKeySimulator_simulateMediaKeyNative(JNIEnv *env, jclass clazz, jint keyCode) {
    (void)env; (void)clazz;
#if defined(_WIN32)
    BYTE vk = 0;
    if (keyCode == 0) vk = VK_MEDIA_PLAY_PAUSE;
    else if (keyCode == 1) vk = VK_MEDIA_NEXT_TRACK;
    else if (keyCode == 2) vk = VK_MEDIA_PREV_TRACK;
