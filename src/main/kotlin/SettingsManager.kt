...
data class AppSettings(
    ...
    val allowRemoteMediaControl: Boolean = true,
    val mediaControlPort: String = "9095"
)
...
object SettingsRepository {
    ...
    private fun loadFromPreferencesLegacy(): AllSettings {
        ...
        val allowRemoteMediaControl = prefs.getBoolean("allow_remote_media_control", true)
        val mediaControlPort = prefs.get("net_media_control_port", "9095")
        ...
        val appSettings = AppSettings(
            ...
            allowRemoteMediaControl = allowRemoteMediaControl,
            mediaControlPort = mediaControlPort
        )
